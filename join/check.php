  ...
  if (isset($_POST) && !empty($_POST)){
    ...
    try {
      ...
      //MySQLが用意してくれる関数
        ...
        // $sql =  "INSERT INTO `members`(`nick_name`, `email`, `password`, `picture_path`, `created`, `modified`) VALUES (nick_nameの値,emailの値,passwordの値,picture_pathの値,now(),now()) "; 
